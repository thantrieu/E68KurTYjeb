...
public class Course {
    ...
    private final ArrayList<TranscriptOfStudent> transcriptOfStudents; // ds sinh viên và bảng điểm tương ứng
    ...
    public void setTranscriptOfStudents(Student student, Transcript transcript) {
        for (TranscriptOfStudent transcriptOfStudent : transcriptOfStudents) {
            if (transcriptOfStudent
                    .student.getId().compareTo(student.getId()) == 0) {
                transcriptOfStudent.transcript = transcript;
    ...
    public static class TranscriptOfStudent {
