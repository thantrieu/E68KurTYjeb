...
public class Lesson64Exercises3 {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 0 -> System.out.println("==> CẢM ƠN BẠN ĐÃ SỬ DỤNG DỊCH VỤ <==");
                case 1 -> {
     ...
     *
     * @param course đối tượng lớp học cần hiển thị
     */
    ...
    private static Student createNewStudent(Scanner input) {
        ...
        return new Student(id, fullName, address,
